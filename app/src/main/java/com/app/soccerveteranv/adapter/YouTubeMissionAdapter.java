...
/**
 * Created by sungbo on 2016-04-10.
 */
public class YouTubeMissionAdapter extends BaseAdapter implements YouTubeThumbnailView.OnInitializedListener {
    ...
    public YouTubeMissionAdapter(Context c, int l, ArrayList<MisstionVo> itemVos){
        this.mContext = c;
        this.inflater = (LayoutInflater) c.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.layout = l;
        this.misstionVos = itemVos;
