 ...
 */
public class YoutubeSampleFragment extends Fragment {
    ...
    public static YoutubeSampleFragment newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        YoutubeSampleFragment fragment = new YoutubeSampleFragment();
